 ...
 */
final class Version20210810181240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device_crafting_experience (id INT AUTO_INCREMENT NOT NULL, device_id INT NOT NULL, research_point_id INT NOT NULL, qty INT UNSIGNED NOT NULL, INDEX IDX_BD246A2494A4C7D4 (device_id), INDEX IDX_BD246A243DD39968 (research_point_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
